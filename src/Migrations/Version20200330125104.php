 ...
 */
final class Version20200330125104 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE assoiffeur CHANGE administrateur_id administrateur_id INT DEFAULT NULL, CHANGE periode_fermeture periode_fermeture VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE carte_bleue CHANGE date_expiration date_expiration DATE NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE assoiffe CHANGE cartebleue_id cartebleue_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE assoiffeur CHANGE administrateur_id administrateur_id INT DEFAULT NULL, CHANGE periode_fermeture periode_fermeture DATE NOT NULL');
        $this->addSql('ALTER TABLE carte_bleue CHANGE date_expiration date_expiration INT NOT NULL');
        $this->addSql('ALTER TABLE commande CHANGE assoiffe_id assoiffe_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE notification CHANGE assoiffe_id assoiffe_id INT DEFAULT NULL');
